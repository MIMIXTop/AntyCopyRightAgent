...
async def get_classroom(url, params):
...
async def get_courses(telegram_id: int):
    ...
    return await get_classroom(url, params)
...
async def get_submissions_status(telegram_id: int, course_id: int, course_work_id: int):
